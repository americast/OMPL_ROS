...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ss/catkin_ws/install/${idir}'.  Ask the maintainer 'Sayan Sinha <sayan.sinha@iitkgp.ac.in>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ss/catkin_ws/install/lib;/home/ss/catkin2/devel/lib;/home/ss/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
